...
const seeds: Seed[] = [
  ...
  {
    title: "White Wine & Adderall",
    artist: "The Chainsmokers",
    album: "White Wine & Adderall",
    dur: 199,
    plays: 5,
    days: 30,
  },
...
export const sampleSongs: Song[] = seeds.map((s, i) => ({
  ...
  lastPlayed: s.plays > 0 ? new Date(NOW - Math.min(s.days, 30) * DAY).toISOString() : undefined,
}));
