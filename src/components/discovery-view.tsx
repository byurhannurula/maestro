...
import type { DiscoveryPlaylist, DiscoveryTrack } from "@/lib/types";
...
export function DiscoveryView({
  ...
  return (
    <div className="relative h-full overflow-y-auto">
      ...
      {/* Download bar */}
      {queued.size > 0 && (
        <div className="pointer-events-none sticky inset-x-0 bottom-[var(--player-bar-offset,1.5rem)] flex justify-center px-3 transition-[bottom] duration-200">
